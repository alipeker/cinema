...
const active_state_enum_1 = require("../entity-store/models/active-state.enum");
function default_1(options) {
    ...
    let files = [
        schematics_1.schematic(plain ? 'store' : 'entity-store', {
            ...
            feature: true,
            spec: options.spec,
            withActive: entityService === "Firebase" /* firebase */ ? active_state_enum_1.ActiveStateType.Single : options.withActive,
